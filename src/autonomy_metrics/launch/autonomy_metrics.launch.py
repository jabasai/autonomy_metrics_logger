...
def generate_launch_description():
    metrics_pkg_dir = get_package_share_directory("autonomy_metrics")

    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "config_yaml",
                default_value=os.path.join(metrics_pkg_dir, "config", "metrics_full.yaml"),
            ),
            ...
            DeclareLaunchArgument("enable_remote_logging", default_value="false"),
            DeclareLaunchArgument("database_name", default_value="robot_incidents"),
            DeclareLaunchArgument("use_webui", default_value="true"),
            ...
            Node(
                ...
                output="screen",
                condition=IfCondition(LaunchConfiguration("use_webui")),
                parameters=[
                    {
